...
composition, and twenty-two achievements naming the strategies that were
...
| `engine/src/achievements.ts` | Twenty-two end-of-term predicates. Nothing feeds back. |
