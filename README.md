...
composition, and twenty-one achievements naming the strategies that were
...
| `engine/src/achievements.ts` | Twenty-one end-of-term predicates. Nothing feeds back. |
...
| `config/events.json` | 25 news events, 56 options. |
